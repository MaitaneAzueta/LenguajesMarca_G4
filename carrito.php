    ...
    <main>
        ...
        <?php if ($datosCompra !== null): ?>
            <section class="detalle-carrito">
                <img src="<?php echo htmlspecialchars($datosCompra['Portada']); ?>" alt="Portada de la película" style="width:200px;"/>
        ...
        <?php else: ?>
            <section class="carrito-vacio">
                <p>No has seleccionado ninguna entrada aún o tu carrito está vacío.</p>
