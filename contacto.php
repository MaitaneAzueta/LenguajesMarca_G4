...
<body class="scan">
    ...
    <main class="contenedor-principal">
        <div class="seccion-contacto">
            ...
            <p class="texto-azul" style="text-align: center; margin-bottom: 40px;">¿Deseas formar parte de nuestra flota o solicitar un transporte? Envía un mensaje a la central.</p>

            <div class="grid-contacto">
                <div class="formulario-container border-azul">
                    <form action="#" method="POST" onsubmit="event.preventDefault(); alert('Mensaje enviado a la central de Hispania Travel. Procesando...');">
                        ...
                        <button type="submit" class="btn-rojo" style="width: 100%; margin-top: 10px;">ENVIAR TRANSMISIÓN</button>
                    </form>
                </div>
